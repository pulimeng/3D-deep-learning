...
class VoxResNetBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn, reg_factor):
        ...
        # last activation
        block_output = _bn_relu(block89)

        # average poll and classification
        pool1 = AveragePooling3D(pool_size=(block89._keras_shape[DIM1_AXIS],
                                            block89._keras_shape[DIM2_AXIS],
                                            block89._keras_shape[DIM3_AXIS]),
